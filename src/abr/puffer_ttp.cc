...
//   if (abr_config["collect_hidden"].as<bool>()) {
//     collect_hidden_ = true;
...
//       // load normalization weights - same as original
//     }
//   }
// }
...
//   const auto curr_tcp_info = client_.tcp_info1();
...
//   if (collect_ttp_) {
//     std::vector<double> parsed_raw_input {raw_input};
//     parsed_raw_input[ttp_input_dim_ - 1] = (double) curr_sizes_[1][0] / PKT_BYTES; // add first next chunk size
//     inputs_.push_back(parsed_raw_input);
//   }
...
//     if (i == 1 && collect_hidden_) {
//       // just the first next horizon
