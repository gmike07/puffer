...
//     use_puffer_ = abr_config["use_puffer"].as<bool>();
//   }
...
//       // load normalization weights - same as the original
//     }
//   }
// }
...
//   if (not use_puffer_) {
//     std::vector<double> p_raw_input{raw_input};
//     p_raw_input[ttp_input_dim_ - 1] = (double) curr_sizes_[1][0] / PKT_BYTES;
//     inputs_.push_back(p_raw_input);
//   }
